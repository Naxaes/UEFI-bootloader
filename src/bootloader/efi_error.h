...
const char* EfiErrorStringA(EFI_STATUS status)
{
    switch (status)
    {
        case EFI_LOAD_ERROR:
        {
            return (const char*) "Load Error";
        }
        case EFI_INVALID_PARAMETER:
        {
            return (const char*) "Invalid Parameter";
        }
        case EFI_UNSUPPORTED:
        {
            return (const char*) "Unsupported";
        }
        case EFI_BAD_BUFFER_SIZE:
        {
            return (const char*) "Bad Buffer Size";
        }
        ...
        case EFI_NOT_READY:
        {
            return (const char*) "Not Ready";
        }
        case EFI_DEVICE_ERROR:
        {
            return (const char*) "Device Error";
        }
        case EFI_WRITE_PROTECTED:
        {
            return (const char*) "Write Protected";
        }
        ...
        {
            return (const char*) "Volume Corrupted";
        }
        case EFI_VOLUME_FULL:
        {
            return (const char*) "Volume Full";
        }
        case EFI_NO_MEDIA:
        {
            return (const char*) "No Media";
        }
        case EFI_MEDIA_CHANGED:
        {
            return (const char*) "Media Changed";
        }
        case EFI_NOT_FOUND:
        {
            return (const char*) "File Not Found";
        }
        case EFI_ACCESS_DENIED:
        {
            return (const char*) "Access Denied";
        }
        case EFI_NO_RESPONSE:
        {
            return (const char*) "No Response";
        }
        case EFI_NO_MAPPING:
        {
            return (const char*) "No Mapping";
        }
        case EFI_TIMEOUT:
        {
        ...
        {
            return (const char*) "Not Started";
        }
        case EFI_ALREADY_STARTED:
        {
            return (const char*) "Already Started";
        }
        case EFI_ABORTED:
        {
            return (const char*) "Aborted";
        }
        case EFI_ICMP_ERROR:
        {
            return (const char*) "ICMP Error";
        }
        case EFI_TFTP_ERROR:
        {
            return (const char*) "TFTP Error";
        }
        ...
        {
            return (const char*) "Incompatible Version";
        }
        case EFI_SECURITY_VIOLATION:
        {
            return (const char*) "Security Violation";
        }
        case EFI_CRC_ERROR:
        {
            return (const char*) "CRC Error";
        }
        case EFI_END_OF_MEDIA:
        {
            return (const char*) "End Of Media";
        }
        case EFI_END_OF_FILE:
        {
            return (const char*) "End Of File";
        }
        case EFI_INVALID_LANGUAGE:
        {
            return (const char*) "Invalid Language";
        }
        case EFI_COMPROMISED_DATA:
        {
            return (const char*) "Compromised Data";
        }
        case EFI_IP_ADDRESS_CONFLICT:
        {
            return (const char*) "IP Address Conflict";
        }
        case EFI_HTTP_ERROR:
        {
            return (const char*) "End Of File";
        ...
        {
            return (const char*) "WARNING - Unknown Glyph";
        }
        case EFI_WARN_DELETE_FAILURE:
        {
            return (const char*) "WARNING - Delete Failure";
        }
        case EFI_WARN_WRITE_FAILURE:
        {
            return (const char*) "WARNING - Write Failure";
        }
        case EFI_WARN_BUFFER_TOO_SMALL:
        {
            return (const char*) "WARNING - Buffer Too Small";
        }
        case EFI_WARN_STALE_DATA:
        {
            return (const char*) "WARNING - Stale Data";
        }
        case EFI_WARN_FILE_SYSTEM:
        {
            return (const char*) "WARNING - File System";
        }
        case EFI_WARN_RESET_REQUIRED:
        {
            return (const char*) "WARNING - Reset Required";
        }
        case EFI_SUCCESS:
        {
            return (const char*) "Successful";
        }
        default:
        {
...
const CHAR16* EfiErrorStringW(EFI_STATUS status)
{
    switch (status)
    {
        case EFI_LOAD_ERROR:
