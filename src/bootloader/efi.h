...
// Color defined in ARGB
#define EFI_GRAPHICS_RED (EFI_GRAPHICS_OUTPUT_BLT_PIXEL) { 0xFF, 0xFF, 0xFF, 0x0 }
...
extern const CHAR16* EFI_MEMORY_TYPE_STRINGS[];
extern const char* EFI_MEMORY_TYPE_STRINGS_CHAR[];
...
extern struct EFI_GUID EFI_FILE_INFO_ID_GUI;
...
// This is the main EFI occupied_pages for all of the EFI.
...
typedef EFI_STATUS (*EFI_TEXT_STRING)(struct EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* This, const CHAR16* String);  // TODO(ted): Can this be const? Spec doesn't mention it.

// We are not using these next three functions,
// but they are required in order for the struct to be filled out.
typedef EFI_STATUS (*EFI_TEXT_TEST_STRING)(struct EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL* This, const CHAR16* String);
